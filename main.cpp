...
struct light li = {
    ...
    .intensity = Eigen::Vector3f(1, 1, 1)};
...
Eigen::Matrix4f getViewMat(
    ...
    Eigen::Vector3f crossGT = cameraLookat.cross(cameraUp);
...
int main(int argc, char** argv) {
    ...
    */
    ...
    const char* obj_path = "../../model/luna/models/heroes/luna/obj/luna_body.obj";
    const char* texture_path =
        "../../model/luna/materialsrc/models/heroes/luna/"
        "luna_body_color.tga";
    ...
    for (auto i = 0; i < height * width; ++i) {
        ...
        color[0] = (unsigned char)(r.getFrameBuf(i).x());
        color[1] = (unsigned char)(r.getFrameBuf(i).y());
        color[2] = (unsigned char)(r.getFrameBuf(i).z());
        fwrite(color, 1, 3, fp);
    }
    fclose(fp);
